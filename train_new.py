...
output_model_file = os.path.join(settings.MODEL_DIR, "new", "bert_pytorch.pth")
...
model = BertForSequenceClassification.from_pretrained("bert_config.json",cache_dir=None,num_labels=len(y_columns))
model.zero_grad()
